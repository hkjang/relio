...
```bash
gunzip -c relio-v1.9.0.tar.gz | docker load
docker image inspect relio:v1.9.0
```
...
./scripts/run-offline-container-test.sh relio:v1.9.0
./scripts/run-upgrade-container-test.sh relio:v1.8.0 relio:v1.9.0
```
