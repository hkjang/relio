...
```bash
gunzip -c relio-v1.11.3.tar.gz | docker load
docker image inspect relio:v1.11.3
```
...
./scripts/run-offline-container-test.sh relio:v1.11.3
./scripts/run-upgrade-container-test.sh relio:v1.11.2 relio:v1.11.3
```
