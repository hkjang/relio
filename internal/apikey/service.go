...
var AllowedScopes = []string{"customer:read", "customer:write", "contact:read", "contact:write", "lead:read", "lead:write", "opportunity:read", "opportunity:write", "activity:read", "activity:write", "product:read", "product:write", "quotation:read", "quotation:write", "contract:read", "contract:write", "sales:read", "sales:write", "target:read", "target:write", "forecast:read", "notification:read", "notification:write", "report:read", "approval:request", "approval:approve", "mcp:use"}
