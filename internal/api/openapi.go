...
func OpenAPI() map[string]any {
	...
	return map[string]any{
		...
		"components": map[string]any{
			...
			"parameters":      map[string]any{"fields": fieldsParameter},
...
func apiPaths() map[string]any {
	return map[string]any{
		"/system/version":               get("서비스 빌드 버전", false),
		"/auth/status":                  get("로컬 로그인 허용 여부와 SSO 사용 여부", false),
		"/auth/login":                   map[string]any{"post": operation("로컬 계정 로그인 및 Session 발급", false)},
		"/auth/logout":                  map[string]any{"post": operation("현재 Session 종료", false)},
		"/auth/me":                      get("현재 로그인 사용자와 권한", false),
		"/auth/oidc/start":              get("Keycloak OIDC 로그인 시작", false),
		"/auth/oidc/callback":           get("Keycloak OIDC 로그인 Callback", false),
		"/me/password":                  map[string]any{"post": operation("내 비밀번호 변경", false)},
		"/dashboard":                    get("Data Scope 적용 대시보드 지표", "opportunity:read"),
		...
		"/opportunities/{id}/playbook":                   get("Stage Sales Playbook", "opportunity:read"),
		"/opportunities/{id}/playbook/{itemId}":          map[string]any{"put": operation("Playbook 항목 진행상태 저장", "opportunity:write")},
